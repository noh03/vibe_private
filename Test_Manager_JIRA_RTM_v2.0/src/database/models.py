...
class IssueBase(Base):
    ...
    # Sync Metadata (JIRA <-> Local 동기화 상태)
    sync_status: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)  # clean/dirty/conflict 등
