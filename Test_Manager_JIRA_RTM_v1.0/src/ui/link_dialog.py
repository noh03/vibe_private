from PyQt6.QtWidgets import QDialog, QVBoxLayout, QTableWidget, QTableWidgetItem, QDialogButtonBox, QComboBox, QLabel, QAbstractItemView, QHeaderView
...
class LinkIssueDialog(QDialog):
    ...
    def accept_selection(self):
        ...
        if rows:
            # The first item in the selection might not be column 0 depending on how user selects
            # But we set selection mode to Rows.
            # Get the item at (currentRow, 0) to be safe
