...
로드 성공 시:
- `MainWindow.jira_config`, `MainWindow.jira_client(JiraRTMClient)` 초기화.
...
### 5.2. RTM 전용 REST (`/rest/rtm/1.0/api/...`)
...
## 10. REST API 상세 사양 (현재 사용/계획 API 전부)

### 10.1. JIRA Server/Data Center REST (`/rest/api/2/...`)
